...
knitr::include_graphics(here('figure','google-trends-interface-page-crypto.png'))
```
...
```{r google-trends-topics-bar-line, fig.height=3, fig.width=8}
## create chart based on search interest over time
...
grid.arrange(pint2, pint1, nrow=1, widths=c(1,8))
```

```{r google-trends-topics-line, fig.height=3, fig.width=8}
## create chart based on search interest over time
