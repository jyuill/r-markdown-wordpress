...
There are some very viable alternatives to dual-axis charts when trying to answer questions about the relationships/trends between to metrics on wildly different scales. 
